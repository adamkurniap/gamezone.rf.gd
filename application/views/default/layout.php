...
<head>
    ...
    <title><?php echo (isset($data['title']) ? $data['title'] : "GAMEZONE") ?></title>
...
<div class="wrapper">
    <header class="container header-wrapper">
      ...
      <a href= <?php echo base_url(); ?> >
        <img alt="GameZone Logo" class="gz-logo" src="<?php echo base_url(); ?>assets/uploads/logo2.png" height="59" width="110" /></a>
                        </div>
                        <?php if(!isset($data['pdf']) || $data['pdf'] == FALSE): ?>
                        <div class="collapse navbar-collapse" id="new-portal-navbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-fw fa-user"></i> Admin <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <?php if(!is_logged_in()): ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <p>
                        &copy; <?php echo date('Y'); ?> THE GAMEZONE. All rights reserved.<br />
                        Edited by <a href="instagr.am/adamkurniap" target="_blank">adamkurniap</a>.
                    </p>
                </div>
            </div>
        </div>
